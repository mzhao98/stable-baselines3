...
class INFLUENCE_PPO_CP_RPD(OnPolicyAlgorithm):
    """
    ...
    def collect_rollouts(
        ...
        while n_steps < n_rollout_steps:
            ...
            record_ego_action = clipped_actions[0]
            record_partner_action = state_t1[-1]
            ...
            if record_ego_action in self.action_to_one_hot and record_partner_action in self.action_to_one_hot:
                record_ego_action = self.action_to_one_hot[record_ego_action]
                record_partner_action = self.action_to_one_hot[record_partner_action]
